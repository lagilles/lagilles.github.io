...
var projects = [
  ...
  },
  {
    ...
    project_skills: ["HTML5", "CSS3", "Bootstrap 4", "JavaScript", "jQuery", "Node.js", "Express"],
  ...
  },
  {
    ...
    project_skills: ["Group Project", "HTML5", "CSS3", "JavaScript", "jQuery", "Firebase"],
  ...
  },
  {
    ...
    project_website: "https://www.lauragillespie.org/",
...
function renderSkillTags(skillArray) {
  ...
  for (var i = 0; i < skillArray.length; i++) {
    var htmlSpan = $("<span>");
    htmlSpan.addClass("badge badge-primary tech " + skillArray[i]).text(skillArray[i]);
